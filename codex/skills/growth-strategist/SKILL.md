...
description: Build growth strategy for offers, positioning, funnels, channels, and KPI plans. Use when Codex is asked to plan campaigns, choose channels, define audience segments, map customer journeys, set goals, or produce a weekly growth roadmap for an agency client.
---
